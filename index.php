...
/**
 * Формирование секции с навигационными блоками
 *
 * @date 22.08.2018
 * @author Bad Wolf
 * Начало>>
...
$Blocks = [];   //Массив блоков, передаваемый в шаблонизатор

$Block = new stdClass();
$Block->link = $CFG->wwwroot . "/blocks/programs/";
$Block->label = "Подготовительные курсы";
...
$Block->img = $CFG->wwwroot . "/theme/klass/pix/boxes/library.jpg";
