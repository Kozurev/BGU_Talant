...
//    }
    ...
    //Телефон
    $mform->addElement("text", "phone1", "Контактный телефон", 'maxlength="100"', 'size="30"');
    $mform->setType("phone1", PARAM_TEXT);
    $mform->addRule("phone1", "Укажите контактный номер телефона", "required", null, "client");
    /**
     * <<Конец
     * @date 24.08.2018
     * @author Bad Wolf
    ...
    if (empty($USER->newadminuser)) {
        ...
        $mform->addElement('checkbox', 'deletepicture', get_string('deletepicture'), null, ["class" => "checkbox"]);
