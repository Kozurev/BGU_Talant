    ...
    <section class="block card mb-3">
        <div class="card-body">
            ...
            <div class="card-text content mt-3">
                <p>Для регистрации на портале необходимо нажать на «Вход» в верхнем правом углу главной страницы сайта.</p>
                <div class="help-img">
                ...
                <p>Необходимо заполнить форму, в которой указать адрес электронной почты, пароль, подтверждение пароля. После чего следует
                    ...
                    для завершения работы с порталом нажмите «Отмена», регистрация не будет произведена, данные будут удалены.</p>
                <div class="help-img">
                ...
                <p>При переходе по ссылке из письма, необходимо заполнить регистрационную карточку пользователя. Все обязательные поля помечены красным. </p>
                <div class="help-img">
                    <img src="<?php $CFG->wwwroot;?>/theme/klass/pix/help/screen5.png" width="100%" />
                    <p></p>
                </div>

                <p>При заполнении личной информации возможно загрузить свою фотографию. Для этого необходимо перетащить файл с рабочего стола в поле для загрузки файлов.</p>
                <div class="help-img">
                ...
                <p>Для продолжения работы на портале, нажмите кнопку «Продолжить». Осуществится переход в личный кабинет.</p>
                <div class="help-img">
