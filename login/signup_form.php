...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        /**
         * Переработка формы регистрации пользователя
         * Убраны ненужные поля, регистрация и авторизация происходит только по Email
         *
         * @date 23.08.2018
         * @author Bad Wolf
         */
...
//        $mform->addRule('username', get_string('missingusername'), 'required', null, 'client');
        ...
        $mform->addElement('password', 'password2', "Подтверждение пароля", 'maxlength="32" size="12"');
