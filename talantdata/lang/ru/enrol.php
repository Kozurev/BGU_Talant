...
/**
 * Strings for component 'enrol', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   enrol
...
$string['privacy:metadata:user_enrolments:tableexplanation'] = 'Место хранения записанных на курс пользователей.';
