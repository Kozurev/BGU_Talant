...
/**
 * Strings for component 'hub', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   hub
...
$string['selecthubinfo'] = 'Общественный каталог — это сервер, на котором перечислены курсы. Вы можете опубликовать информацию о курсах только в тех каталогах, в которых зарегистрирован этот сайт Moodle. Если необходимого Вам каталога нет в списке ниже, свяжитесь с администратором вашего сайта.';
...
$string['siteprivacy'] = 'Включение сайта в список';
...
$string['siteprivacylinked'] = 'Публиковать название моего сайта со ссылкой';
$string['siteprivacynotpublished'] = 'Не включать мой сайт в список';
$string['siteprivacypublished'] = 'Опубликовать только название моего сайта';
...
$string['unlistedurl'] = 'URL каталога без списка';
$string['unprioritise'] = 'Убрать приоритет';
$string['unpublish'] = 'Убрать из публикации';
$string['unpublishalladvertisedcourses'] = 'Убрать все курсы, которые были опубликованы на Moodle.net для записи на них';
...
$string['unpublishcourse'] = 'Убрать из публикации «{$a}»';
...
$string['xmlrpcdisabledpublish'] = 'На сервере не включено расширение XML-RPC, поэтому Вы не можете публиковать курсы и управлять ими.';
$string['xmlrpcdisabledregistration'] = 'На сервере не включено расширение XML-RPC. Пока Вы его не включите, Вы не сможете удалить или обновить Ваши регистрационные данные.';
