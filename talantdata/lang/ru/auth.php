...
/**
 * Strings for component 'auth', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   auth
...
$string['auth_updatelocal_expl'] = '<p><b>Обновление локальной учетной записи:</b> если параметр включен, то значения полей будут заменяться данными из внешнего источника аутентификации при каждом входе пользователя и при синхронизации пользователей. Поля, для которых включено локальное обновление, следует заблокировать.</p>';
$string['auth_updatelocalfield'] = 'Обновить локальных ({$a})';
$string['auth_updateremote'] = 'Обновление внешней учетной записи';
$string['auth_updateremote_expl'] = '<p><b>Обновление внешней учетной записи:</b> если параметр включен, то информация во внешнем источнике авторизации будет обновлена при обновлении учетных записей пользователей в Moodle. Поля, должны быть разблокированы, чтобы позволять редактирование.</p>';
