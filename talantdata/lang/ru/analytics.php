...
/**
 * Strings for component 'analytics', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   analytics
...
$string['errornoindicators'] = 'У этой модели нет индикаторов.';
...
$string['predictionsprocessor_help'] = 'Обработчик прогнозов — это механизм машинного обучения, который обрабатывает наборы данных, генерируемые путем вычисления показателей и целей моделей. Все подготовленные алгоритмы и прогнозы будут удалены, если вы перейдете на другой обработчик прогнозов.';
