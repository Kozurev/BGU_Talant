...
/**
 * Strings for component 'blog', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   blog
...
$string['privacy:metadata:external:userid'] = 'ID пользователя, который добавил внешнюю запись в блог.';
