...
/**
 * Strings for component 'auth_oauth2', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   auth_oauth2
...
$string['privacy:metadata:auth_oauth2:issuerid'] = 'Идентификатор поставщика OAuth 2 для этого входа OAuth 2.';
