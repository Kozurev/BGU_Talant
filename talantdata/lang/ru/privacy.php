...
/**
 * Strings for component 'privacy', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   privacy
...
$string['trace:deletingapproved'] = 'Выполняется удаление одобренных контекстов: {$a->total} ({$a->datetime})';
...
$string['trace:fetchcomponents'] = 'Получение компонентов:  {$a->total} ({$a->datetime})';
