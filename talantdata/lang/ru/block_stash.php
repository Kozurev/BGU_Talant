...
/**
 * Strings for component 'block_stash', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   block_stash
...
$string['drops_help'] = '<p>Расположения - это места , где расположены ваши предметы в <em>виртальном мире</em>. Без указания расположения студенты не смогут забрать предметы.</p>
