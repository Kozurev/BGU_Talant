...
/**
 * Strings for component 'block_enrolmenttimer', language 'ru', branch 'MOODLE_34_STABLE'
 *
...
$string['enrolmenttimer'] = 'Таймер записи на курс';
$string['enrolmenttimer:addinstance'] = 'Добавить новый Таймер записи на курс';
$string['expirytext'] = 'до окончания записи на курс';
$string['pluginname'] = 'Таймер записи на курс';
