...
/**
 * Strings for component 'completion', language 'ru', branch 'MOODLE_35_STABLE'
 *
 * @package   completion
...
$string['eventcoursemodulecompletionupdated'] = 'Завершение элемента курса обновлено';
...
$string['privacy:metadata:coursemodulesummary'] = 'Хранит данные о завершении элементов для пользователя';
...
$string['privacy:metadata:overrideby'] = 'ID пользователя, который переопределил завершение элемента';
...
$string['privacy:metadata:timemodified'] = 'Время, когда завершение элемента было изменено';
