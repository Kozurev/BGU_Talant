...
class coursecat implements renderable, cacheable_object, IteratorAggregate {
    ...
    public static function create($data, $editoroptions = null) {
        ...
        /**
         * Привязка логотипа к категории по полям course_category.logo -> files.itemid
         *
         * @date 23.08.2018
         * @author Bad Wolf
         */
        $DB->set_field( "course_categories", "logo", $data->logo, ["id" => $newcategory->id] );
    ...
    public function update($data, $editoroptions = null) {
         ...
         * @author Bad Wolf
         */
        $DB->set_field( "course_categories", "logo", $data->logo, ["id" => $data->id] );
    ...
    public function delete_full($showfeedback = true) {
        ...
        /**
         * Удаление логотипа категории
         * //TODO: реализовать удаление не только записи в бд, но и сам файл
         *
         * @date 23.08.2018
         * @author Bad Wolf
         */
        $DB->delete_records('files', ['itemid' => $category->logo]);
