...
/**
 * Костыль для отказа от прав доступа на загруженные файлы
 * для логотипов разделов и других
 * Чтобы вернуть всё обратно необходимо раскоментировать строки 73-81 и 33
 *
 * @date 23.08.2018
 * @author Bad Wolf
 */
...
$fullpath = "/$contextid/user/draft/$draftid/$relativepath";
